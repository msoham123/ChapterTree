                ...
                SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      Column(
                        children: <Widget>[
                          Image.asset("./assets/images/pick_chapter.png"),
                          Container(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: SimpleRoundButton(
                              ...
                              onPressed: () async {
                                DocumentSnapshot documentSnapshot = await Firestore.instance.collection("fbla_users").document(widget.UID).get();

                                int lastCount = 0;
                                if(documentSnapshot.data != null) {
                                  if(documentSnapshot.data['count'] != 0) {
                                    lastCount = documentSnapshot.data['count'];
                                  }
                                } else {
                                  print("Null");
                                }

                                ds = new DatabaseService(uid: widget.user.uid);
                                ds.updateUserData(widget.user.displayName, lastCount, chapter,
                                    widget.user.phoneNumber, false, []);
